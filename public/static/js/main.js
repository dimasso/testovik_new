...
var Jarallax = function () {
    function Jarallax(item, userOptions) {
        ...
        if (deprecatedDataAttribute) {
            console.warn('Detected usage of deprecated data-jarallax JSON options');
        }
...
module.exports = function(Chart) {
	...
	var TimeScale = Chart.Scale.extend({
		initialize: function() {
			if (!moment) {
				throw new Error('Chart.js - Moment.js could not be found!');
			}
...
/// <reference path='/static/js/lib/ofi.js' />
/// <reference path='/static/js/lib/jarallax.js' />
/// <reference path='/static/js/lib/jarallax-video.js' />
/// <reference path='/static/js/lib/lazyload.js' />
/// <reference path='/static/js/lib/aos.js' />
/// <reference path='/static/js/lib/slick.js' />
/// <reference path='/static/js/lib/jquery.countTo.js' />
/// <reference path='/static/js/lib/masonry.pkgd.js' />
/// <reference path='/static/js/lib/jquery.fancybox.js' />
/// <reference path='/static/js/lib/countdown.js' />
/// <reference path='/static/js/lib/Chart.js' />
/// <reference path='/static/js/lib/TimeCircles.js' />
/// <reference path='/static/js/lib/jquery.nice-select.js' />
